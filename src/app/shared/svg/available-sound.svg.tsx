...
const AvailableSoundSvg: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 38 38' aria-hidden='true' {...props}>
    <path
      stroke='#007AFF'
      strokeLinecap='round'
...
export default AvailableSoundSvg
